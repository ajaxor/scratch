...
export class Renderer{
 ...
 if(s.room==='W2'){this.rect(4*T+21,0,5,3*T+8,'#9a9067');if(flowing(s))this.glow(8.5*T,6.5*T,160,'#47c8dd33');}
 ...
 object(o,t){const c=this.ctx,g=this.game,s=g.state,w=s.world,x=o.x*T,y=o.y*T,cx=x+(o.w||1)*T/2,cy=y+24;
  ...
  if(o.type==='grate'&&w.works.grateClear){this.arch(15,x,y,48,48,.45);return;}
  ...
  if(o.propSprite!==undefined){if(o.type==='weighbed')this.prop(3,x,y,48,48,balanced(s)?1:.65);else this.prop(o.propSprite,x-4,y-12,56,60);if(o.type==='mouth'&&flowing(s))this.glow(cx,cy,40,'#75d9d433');if(o.type==='diverter')this.text(['♧','∪','♪'][w.works.diverter],cx,y+43,'#f2d798',18);return;}
